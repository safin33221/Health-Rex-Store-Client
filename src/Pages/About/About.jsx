...
const About = () => {
    ...
    return (
        <div className=''>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4  mt-24 w-full'>
                <div className='m-4 rounded-xl mx-auto'>
                ...
                <div className='m-5'>
                    ...
                    <p>At HealthRex Store, we believe that access to quality healthcare should be simple, affordable, and hassle-free. Our journey began with a simple yet powerful vision: to bridge the gap between people and essential medicines by bringing authentic pharmaceutical products right to their doorstep.
                        ...
                        Today, HealthRex Store is more than just an online pharmacy—it’s a trusted healthcare partner committed to ensuring that you get the right medicines, at the right time, with the best service. Our mission is to empower healthier lives by providing a seamless and secure way to purchase medicines online.</p>
                </div>
            </div>
