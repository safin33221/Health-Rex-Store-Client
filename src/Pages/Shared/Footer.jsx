...
const Footer = () => {
    return (
        <footer className="footer footer-center  text-base-300 shadow-2xl border-t rounded p-10">
            ...
            <aside>
                <p>Copyright © {new Date().getFullYear()} - All right reserved by HealthRxStore Industries Ltd</p>
            </aside>
        </footer>
    );
};
